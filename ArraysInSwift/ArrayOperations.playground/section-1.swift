...
let helloTwice = Array(count: 2, repeatedValue: "Hello")  // ["Hello", "Hello"]
...
twomultiples.insert(6, atIndex: 3) // [0, 2, 4, 6, 8]
...
twomultiples.removeAtIndex(1)// 2
...
let reverseArray = integerArray.reverse()
